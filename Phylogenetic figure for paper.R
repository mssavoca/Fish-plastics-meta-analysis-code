...
col.Salmoniformes <- "#3CBB75FF" # grean-teal
col.Atheriniformes <- "#3CBB75FF" # grean-teal
col.Myliobatiformes <- "#3CBB75FF" # grean-teal
col.Torpediniformes <- "#3CBB75FF" # grean-teal
col.Ophidiiformes <- "#3CBB75FF" # grean-teal
col.Osmeriformes <- "#3CBB75FF" # grean-teal
col.Zeiformes <- "#3CBB75FF" # grean-teal
col.Squaliformes <- "#3CBB75FF" # grean-teal
col.Lamniformes <- "#3CBB75FF" # grean-teal
col.Scorpaeniformes <- "#3CBB75FF" # grean-teal
col.Carcharhiniformes <- "#3CBB75FF" # grean-teal
col.Gadiformes <- "#3CBB75FF" # grean-teal
col.Anguilliformes <- "#3CBB75FF" # grean-teal
col.Rajiformes <- "#3CBB75FF" # grean-teal
col.Lophiiformes <- "#3CBB75FF" # grean-teal
col.Batrachoidiformes <- "#3CBB75FF" # grean-teal
col.Beryciformes <- "#3CBB75FF" # grean-teal
